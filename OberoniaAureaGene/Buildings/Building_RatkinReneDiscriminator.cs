...
public class Building_RatkinGeneDiscriminator : Building_GeneExtractorBase
{
    protected override int TicksToExtract => 180000;
    ...
    protected override void FinishWork()
    {
        ...
        {
            Messages.Message("OAGene_GeneExtractionFail".Translate(containedPawn.Named("PAWN")).CapitalizeFirst(), containedPawn, MessageTypeDefOf.NegativeEvent);
        }
        base.FinishWork();
    }
}